...
set @user1 = select id from final table (insert into users(username, password) values('test_username', 'test_password'));

insert into users_roles(user_id, role_id) values (@user1, @role1);